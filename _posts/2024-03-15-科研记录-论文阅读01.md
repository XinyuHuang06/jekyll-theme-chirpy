...
&+\sum_{n=1}^{N} v_n \left({\left( \boldsymbol{x}_r-\boldsymbol{c}_r \right)}^H \chi_{n,r} {\left( \boldsymbol{x}_r-\boldsymbol{c}_r \right)}- \vartheta-h\right)\\
&+\sum_{n=1}^{N} \frac{\rho_n}{2} {\Vert{\left( \boldsymbol{x}_r-\boldsymbol{c}_r \right)}^H \chi_{n,r} {\left( \boldsymbol{x}_r-\boldsymbol{c}_r \right)}- \vartheta-h\Vert}^2
\end{array}
\label{larfun_1}
$$
