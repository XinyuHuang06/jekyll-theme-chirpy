...
import LAppDefine from "./LAppDefineV2"
...
//============================================================
//============================================================
export default function LAppModelV2() {
...
LAppModelV2.prototype = new L2DBaseModel();
                ...
                thisRef.loadTexture(i, texPaths, function () {
                    ...
                    if (thisRef.isTexLoaded) {
                        ...
                        if (thisRef.modelSetting.getHitAreasCustom() != null) {
                            ...
                            LAppDefine.hit_areas_custom_head_x = undefined;
                            LAppDefine.hit_areas_custom_head_y = undefined;
                            LAppDefine.hit_areas_custom_body_x = undefined;
                            LAppDefine.hit_areas_custom_body_y = undefined;
                        }
...
LAppModelV2.prototype.update = function () {
    ...
    if (this.mainMotionManager.isFinished()) {
        ...
        if (Sleepy === '1' && this.hasSleepyMotion) {
            this.hasSleepyMotion = this.startRandomMotion(LAppDefine.MOTION_GROUP_SLEEPY, LAppDefine.PRIORITY_SLEEPY);
        } else {
...
LAppModelV2.prototype.startMotion = function (name, no, priority) {
    LAppDefine.DEBUG_LOG && console.log(`[Live2Dv2] startMotion: ${name} No: ${no} Priority: ${priority}`);
